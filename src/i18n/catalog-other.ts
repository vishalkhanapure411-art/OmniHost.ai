...
export const hiIN: Partial<Record<MessageKey, string>> = {
  ...
  "mdm.articles.column.lastChange": "अंतिम परिवर्तन",
  "mdm.articles.compliance.notConfigured": "कॉन्फ़िगर नहीं",
  "mdm.articles.compliance.unchecked": "जाँच नहीं हुई",
  "mdm.articles.filter.incomplete": "केवल अपूर्ण रिकॉर्ड",
  "mdm.uom.label.POR": "हिस्सा",
  "mdm.uom.label.PC": "नग",
  "mdm.uom.label.PLT": "प्लेट",
  "mdm.uom.label.GLS": "ग्लास",
  "mdm.articles.empty.title": "इस चेन में अभी कोई लेख नहीं है",
  "mdm.article.status.active": "सक्रिय",
  "mdm.article.status.draft": "ड्राफ़्ट",
  // The record screen, added in the same slab as its English keys and left partial on
  // purpose: an untranslated key falls back to English rather than rendering a key or an
  // empty box, and the language switcher reports the coverage figure.
  "mdm.article.detail.back": "सूची पर वापस",
  "mdm.article.section.identity": "पहचान",
  "mdm.article.section.selling": "बिक्री",
  "mdm.article.section.compliance": "अनुपालन",
  "mdm.article.section.versions": "संस्करण",
  "mdm.article.field.code": "कोड",
  "mdm.article.field.name": "नाम",
  "mdm.article.field.category": "श्रेणी",
  "mdm.article.field.status": "स्थिति",
  "mdm.article.field.version": "संस्करण",
  "mdm.article.price.title": "प्रति आउटलेट मूल्य",
  "mdm.article.availability.title": "प्रति आउटलेट उपलब्धता",
  "mdm.article.availability.state.available": "उपलब्ध",
  "mdm.article.availability.state.unavailable": "अनुपलब्ध",
  "mdm.article.availability.state.seasonal": "मौसमी",
  "mdm.article.allergen.title": "एलर्जेन घोषणा",
  "mdm.article.nutrition.title": "पोषण",
  "mdm.erp.section.title": "ईआरपी-संचालित",
  "mdm.erp.section.count": "{system} द्वारा संचालित {count} फ़ील्ड",
  "mdm.erp.chip.label": "स्रोत-प्रमाण",
  "mdm.erp.chip.close": "बंद करें",
  "action.cancel": "रद्द करें",
  "nav.route./mdm/import": "मास्टर डेटा आयात",
  "mdm.import.title": "मास्टर डेटा आयात",
  "mdm.import.action.dryRun": "फ़ाइल जाँचें",
  "mdm.import.action.commit": "आयात लागू करें",
  "mdm.import.column.line": "पंक्ति",
  "mdm.import.column.code": "कोड",
  "mdm.import.column.outcome": "परिणाम",
  "mdm.import.column.issues": "कारण",
  "mdm.import.outcome.created": "बनाया",
